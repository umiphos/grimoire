		...
		<div id="ResultadosAvansado" >
		  ...
		  <?php  
			...
			if(isset($_GET['search'])){
				...
				$_GET['Cpp'],$_GET['distrito'],$_GET['clave']);
			...
			/*
			echo "<input type='radio' name='docu' value='1'> Bienvenida";
			echo "<input type='radio' name='docu' value='2'> Nombramiento";
			echo "<input type='radio' name='docu' value='3'> Membretado";
			echo "<input type='radio' name='docu' value='4'> Sobres";
			echo "<input type='radio' name='docu' value='5'> Credencial";
			echo "<th></th>";
